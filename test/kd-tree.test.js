...
describe('kdTree', () => {
    it('should create a tree correctly', () => {
        ...
        // let perm = depthFirstCollect(tree, iparr.idx, 0);

        // let iparr_new = permutePointArray(iparr, perm);

        // console.log(iparr_new.x)
        // console.log(iparr_new.y)
        // console.log(iparr_new.z)
        // TODO: create new verts, cov matrices, etc. from idx
    });
    ...
    it('should sort the tree by depth correctly', () => {
        ...
        expect(tree.cleft.cleft.range).to.deep.equal([6, 8]);
        expect(tree.cleft.cright.range).to.deep.equal([4, 6]);
        expect(tree.cright.d).to.equal(1);
        expect(tree.cright.val).to.equal(2.5);
        expect(tree.cright.cleft.range).to.deep.equal([2, 4]);
        expect(tree.cright.cright.range).to.deep.equal([0, 2]);
    });
    ...
    it('should sort the tree by reverse depth correctly', () => {
        ...
        viewDepthSort(tree, {x: 3, y: -3, z: -3}, 'reverse');
