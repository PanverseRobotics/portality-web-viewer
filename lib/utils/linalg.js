...
/**
 * Generates a view matrix with the given eye position, focal point, and up axis
 *
 * @param {mat4} out mat4 frustum matrix will be written into
...
/**
 * Get the top left 3x3 submatrix of a mat4
 * 
 * @param {mat3} out 
 * @param {mat4} a 
 */
function submat3(out, a) {
    out[0] = a[0];
    out[1] = a[1];
    out[2] = a[2];
    out[3] = a[4];
 ...
 * @returns {mat3} out
 */
function mat3vecmultiply(out, a, b) {
    var a00 = a[0], a01 = a[1], a02 = a[2],
        a10 = a[3], a11 = a[4], a12 = a[5],
        a20 = a[6], a21 = a[7], a22 = a[8],
