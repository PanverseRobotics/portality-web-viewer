...
function viewMoveTouch(event, lastTouchPosition, viewParams) {
    ...
    if (event.touches.length == 1) {
        ...
        viewDollyTranslateRotateTouch(event.touches, lastTouchPosition, viewParams);
...
export { viewMoveMouse, viewDollyWheelTranslate, viewMoveKey, viewMoveTouch, viewAutoSpin, stopAutoSpin, getRadius };