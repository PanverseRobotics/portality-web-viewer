 ...
 */
export function viewDepthSort(kdt, p)
{
    return viewDepthSortStep(kdt, p, 0);
}

function viewDepthSortStep(kdt, p, dim) {
    if (kdt == null) {
        return;
    }
    ...
    if (kdt.hasOwnProperty('val')) {
        ...
        viewDepthSortStep(kdt.cleft, p, (dim+1)%3);
        viewDepthSortStep(kdt.cright, p, (dim+1)%3);
        return;
    }
