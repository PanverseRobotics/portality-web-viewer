function toTexture(gl, x, n, m, elType='float', nChannels=1) {
    ...
    return {
        texture: inTexture,
        type: 'ArrayTexture(1)',
        toArray: () => toArrayFunc(gl.createFramebuffer(), inTexture, n, m, gl[texTyp])
    };
}