function toArrayFunc(gl, frameBuffer, texture, n, m, texType=gl.FLOAT, nChannels=1){
    ...
    function renderRawOutput() {
        ...
        const result = new Float32Array(((size[0] * size[1]) * 4 * nChannels));
        gl.readPixels(0, 0, size[0], size[1], gl.RGBA, texType, result);
        return result;
    }
